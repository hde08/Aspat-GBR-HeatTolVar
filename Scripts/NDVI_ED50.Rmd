...
df_hyper=read.csv(paste0(path,"Data/GBR_Hyperspec/ECT1_Aspat_Hyperspec_NDVI.csv"),header=T)
...
for(m in metric){
  ...
  saveRDS(model.W2.3,file=paste0("/home/hugo/Outputs/NDVI/",site,"_",m,"_W2.3_wconstraint.rds"))
}
}
...
for(m in metric){
  for(site in unique(df_hyper$Site.name)){
    model_W2.3=readRDS(paste0("/home/hugo/Outputs/NDVI/",site,"_",m,"_W2.3_wconstraint.rds"))
...
write.csv(df_ed,paste0("/home/hugo/Outputs/NDVI/","NDVI_ED50s.csv",row.names=F))

write.csv(df_param,paste0("/home/hugo/Outputs/NDVI/","Parameters_W2.3.csv"))
