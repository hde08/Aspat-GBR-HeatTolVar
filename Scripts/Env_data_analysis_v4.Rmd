---
title: "Environment_data_analysis_v2"
author: "Hugo DENIS"
date: "22/07/2022"
...
## This script is the re-Analysis of environmental data at ECT1 sites
## For A.spathulata data after re-extracion of environmental variables from
#various sources at the colony level when available 

#Think about incorporating PCAtest
...
```{r}
path="/data1/Denis/"
colony_env=read.csv(paste0(path,"Hugo/Data/GBR_env_data/ECT1_Aspat_colonies_environmental_data_24metrics.csv"),header=T)
...
cor=cor(colony_env_sub,method="pearson")

png(height=465, width=465, file=paste0(path,"Hugo/Figures/Env_analysis/Env_var_correlations_reduced_v8.png"),res=300,units='mm')
...
cor_uncor=cor(colony_env_uncor)
write.csv(cor_uncor,paste0(path,"Hugo/Data/GBR_env_data/ECT1_Aspat_colonies_environmental_data_inf_0.7_correlation_matrix.csv"),row.names=F)

#%ake table of uncorrelated variables to use in random forest 
colony_env_sub_uncor$Genotype=rownames(colony_env_sub_uncor)
write.csv(colony_env_sub_uncor,paste0(path,"Hugo/Data/GBR_env_data/ECT1_Aspat_colonies_environmental_data_uncor_v3_0.7.csv"),row.names=F)
...
colony_env_wide_red=read.csv(paste0(path,"Data/GBR_env_data/ECT1_Aspat_colonies_environmental_data_uncor_v3_0.7.csv"),header=T)

colony_env_wide_all=read.csv(paste0(path,"Data/GBR_env_data/ECT1_Aspat_colonies_environmental_data_24metrics.csv"),header=T)
...
ggsave(pca_plot,filename=paste0(path,"Figures/Env_analysis/PCA_env_colonies_red_v3.png"),width=14,height=10,dpi=320)
```