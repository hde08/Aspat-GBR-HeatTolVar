...
Pelorus East : n=20
```{r}
chla=read.csv(paste0(path,"Data/GBR_Physio/Aspath_chla.csv"),header=T)
```
...
ggsave(both_plot,filename=paste0(path,"Figures/Physio_analysis/NDVI_Chla_correlation.png"),width=12,height=8,dpi=320)
```
