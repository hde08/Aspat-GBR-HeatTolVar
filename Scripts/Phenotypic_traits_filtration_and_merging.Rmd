...
FvFm_ratio=read.csv(paste0(path,"/Data/GBR_PAM/FvFm_ratios_adjusted.csv"),header=T)
FvFm_ratio$Ratio_FvFm.adj=FvFm_ratio$Ratio_FvFm.adj2



FvFm_ed50=read.csv(paste0(path,"Data/GBR_PAM/FvFm_ED50s_drc_withqc.csv"),header=T)

Hyperspec_ed50=read.csv(paste0(path,"Results/GBR_ED50/EDs_Hyperspec_W2.3.csv"),header=T)
Hyperspec_ed50$CI=Hyperspec_ed50$Upper-Hyperspec_ed50$Lower

Hyperspec_ratio=read.csv(paste0(path,"Data/GBR_Hyperspec/NDVI_ratios_adjusted.csv"),header=T)
