...
path="/data1/Denis/"
source(paste0(path,"Hugo/Scripts/cforest_plotting_functions.R"))
```
...
write.csv(df_mtry,"/home/hugo/Outputs/RF_mtry_tuning.csv",row.names=F)
```
...
write.csv(df_mse,"/home/hugo/Outputs/RF_ntree_tuning.csv",row.names=F)
```
...
write.csv(Imp_rf_rep,"/home/hugo/Outputs/PhenoxEnv/RF_var_importance_scaled.csv",row.names=F)
write.csv(Pred_accuracy,"/home/hugo/Outputs/PhenoxEnv/RF_var_pred_accuracy_scaled.csv",row.names=F)
...
write.csv(Imp_rf_rep_summary,"/home/hugo/Outputs/PhenoxEnv/RF_var_importance_summary.csv",row.names=F)
```
...
ggsave(tuning_plot,filename=paste0(path,"Hugo/Figures/Phenotype_x_Env/FvFm_ED50_rf_tuning_parameters.png"),width=14,height=8,dpi=320)
